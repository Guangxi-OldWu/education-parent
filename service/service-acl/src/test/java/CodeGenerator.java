...
//        String projectPath = System.getProperty("user.dir");//得到当前文件夹路径
        gc.setOutputDir("D:\\SpringCloudStudy\\education-parent\\service\\service-acl\\src\\main\\java");
        gc.setAuthor("OldWu");
        ...
        strategy.setInclude("acl_permission","acl_role","acl_role_permission","acl_user","acl_user_role"); //表名，多张逗号分割
